...
impl NetworkState {
    ...
    /// [NipartError].
    pub fn new_from_json(net_state_json: &str) -> Result<Self, NipartError> {
    ...
    pub fn retrieve(&mut self) -> Result<&mut Self, NipartError> {
        Err(NipartError::new(
    ...
    pub fn gen_conf(
        &self,
    ) -> Result<HashMap<String, Vec<(String, String)>>, NipartError> {
        Err(NipartError::new(
            ErrorKind::DependencyError,
    ...
    #[cfg(not(feature = "query_apply"))]
    pub fn checkpoint_rollback(_checkpoint: &str) -> Result<(), NipartError> {
        Err(NipartError::new(
            ErrorKind::DependencyError,
    ...
    #[cfg(not(feature = "query_apply"))]
    pub fn checkpoint_commit(_checkpoint: &str) -> Result<(), NipartError> {
        Err(NipartError::new(
            ErrorKind::DependencyError,
