...
impl OvnConfiguration {
    ...
    fn sanitize_unique_localnet_keys(&self) -> Result<(), NipartError> {
...
impl TryFrom<&str> for OvnConfiguration {
    ...
    fn try_from(maps_str: &str) -> Result<Self, NipartError> {
...
impl TryFrom<&str> for OvnBridgeMapping {
    ...
    fn try_from(map_str: &str) -> Result<Self, NipartError> {
...
impl OvnBridgeMapping {
    ...
    pub fn sanitize(&mut self) -> Result<(), NipartError> {
        if !self.is_absent() {
            self.state = None;
        }
