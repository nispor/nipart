...
impl MergedInterfaces {
    ...
    fn process(&mut self) -> Result<(), NipartError> {
    ...
    fn apply_copy_mac_from(&mut self) -> Result<(), NipartError> {
    ...
    fn mark_orphan_interface_as_absent(&mut self) -> Result<(), NipartError> {
