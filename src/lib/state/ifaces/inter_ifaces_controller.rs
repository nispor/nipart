...
impl MergedInterfaces {
    ...
    pub(crate) fn handle_changed_ports(&mut self) -> Result<(), NipartError> {
    ...
    pub(crate) fn check_overbook_ports(&self) -> Result<(), NipartError> {
    ...
    pub(crate) fn check_infiniband_as_ports(&self) -> Result<(), NipartError> {
