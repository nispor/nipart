...
impl TryFrom<NumberAsString> for BondMode {
    ...
    fn try_from(s: NumberAsString) -> Result<Self, NipartError> {
        match s.as_str() {
...
pub struct BondOptions {
    #[serde(
        skip_serializing_if = "Option::is_none",
        default,
        deserialize_with = "crate::state::deserializer::option_u16_or_string"
    )]
    ...
    #[serde(
        skip_serializing_if = "Option::is_none",
        default,
        deserialize_with = "crate::state::deserializer::option_u8_or_string"
    )]
...
pub struct BondPortConfig {
    ...
    #[serde(
        skip_serializing_if = "Option::is_none",
        default,
        deserialize_with = "crate::state::deserializer::option_i32_or_string"
    )]
